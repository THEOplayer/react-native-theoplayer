...
- Added multiple configuration options to the GoogleImaConfiguration for both iOS and Android. These map to the corresponding IMASettings from the underlying native Google IMA SDK's.
