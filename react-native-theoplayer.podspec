...
Pod::Spec.new do |s|
  ...
  s.dependency "THEOplayerSDK-core", "~> 11.7"

  # THEOlive Dependency
  puts "Adding THEOplayer-Integration-THEOlive"
  s.dependency "THEOplayer-Integration-THEOlive", "~> 11.7"

  # Feature based integration dependencies
  if theofeatures.include?("GOOGLE_IMA")
	puts "Adding THEOplayer-Integration-GoogleIMA"
    s.dependency "THEOplayer-Integration-GoogleIMA", "~> 11.7"
  end

  if theofeatures.include?("CHROMECAST")
	puts "Adding THEOplayer-Integration-GoogleCast"
    s.ios.dependency "THEOplayer-Integration-GoogleCast", "~> 11.7"
  end

  if theofeatures.include?("THEO_ADS")
	puts "Adding THEOplayer-Integration-THEOads"
    s.dependency "THEOplayer-Integration-THEOads", "~> 11.7"
  end

  if theofeatures.include?("MILLICAST")
  puts "Adding THEOplayer-Integration-Millicast"
    s.dependency "THEOplayer-Integration-Millicast", "~> 11.7"
  end
